...
mysqli_connect("localhost","root","","orphan") or die(mysqli_error());
...
// mysqli_select_db("orphan") or die(mysql_error());
        
$result=mysqli_query($conn,"select * from pay") or die(mysqli_error());
...
$result=mysqli_query($conn,"select * from adoption") or die(mysqli_error());
...
// mysqli_select_db("orphan") or die(mysqli_error());
        
$result=mysqli_query($conn,"select * from pro1_vol") or die(mysqli_error());
...
$result=mysqli_query($conn,"select * from reg_vol") or die(mysqli_error());
